  ...
  <div class="contianer">
        <div class="row mt-5">
            <div class="col-12 mt-5">
                <h1 class="text-dark text-center h1"> Neg&Pos Numbers </h1>
            </div>
            <div class="col-4 offset-4">
                <form method="post">
                    <div class="form-group">
                        <input type="number" name="num" id="id" class="form-control mt-5" placeholder="Enter number" aria-describedby="helpId">
                    </div>
                    <div class="form-group">
